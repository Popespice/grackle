...
// per-panel crashes are isolated by SlotContainer's ErrorBoundary (PR #46);
// this one additionally catches app-shell / registry-init crashes outside
// any panel, which matters more for an unattended visitor-facing preview.
